...
{
    UINT32 *p = (VOID*) TRI_STATE_KEY_SILENT_STATUS_ADDR - TLMM_PIN_IO_REGISTER;
    *p = 0x0;
    p = (VOID*) TRI_STATE_KEY_VIBRATE_STATUS_ADDR - TLMM_PIN_IO_REGISTER;
    *p = 0x0;
    p = (VOID*) TRI_STATE_KEY_RING_STATUS_ADDR - TLMM_PIN_IO_REGISTER;
    *p = 0x0;

   return (MmioRead32(TRI_STATE_KEY_SILENT_STATUS_ADDR) & 1) == 1; // Enter UEFI if slide key to silent.
//    return FALSE;
}
