...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    {"RAM Partition",     0x80000000, 0x01600000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
    {"TGCM",              0x81600000, 0x01400000, AddMem, MEM_RES, WRITE_COMBINEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
    ...
    {"RAM Partition",     0x85F00000, 0x00020000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
    ...
    {"TZApps",            0x87A00000, 0x05D00000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
    {"PIL_REGION",        0x8D700000, 0x0F400000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, UNCACHED_UNBUFFERED_XN},
    {"RAM Partition",     0x9CB00000, 0x00500000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
    {"Display Reserved",  0x9D000000, 0x02400000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
    ...
    //{"DXE Heap",          0xA8800000, 0x03500000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
    //{"RAM Partition",     0xABD00000, 0x0FE00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},

    /* 0xA0000000 to MEMORY_HOLE_BASE will be added by RamPartition Dxe later. */

    /* DDR Bank 0 End */
    /* Carveout Region (0xBBB00000 -> 0xBFFFFFFF) */
    /* DDR Bank 1 Start */
...
//    {"RAM Partition",     0x180000000,0x80000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
 ...
 //   {"RAM Partition",     0x200000000,0x80000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
    ...
    /* Only Mapped 4GB, Ram Partition Dxe will map other regions later.*/
