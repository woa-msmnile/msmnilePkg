...
// OP7TP Modify Start
#define TRI_STATE_KEY_RING_STATUS_ADDR                                           \
  (TLMM_EAST + TLMM_ADDR_OFFSET_FOR_PIN(27) + TLMM_PIN_IO_REGISTER)

#define TRI_STATE_KEY_VIBRATE_STATUS_ADDR                                           \
  (TLMM_SOUTH + TLMM_ADDR_OFFSET_FOR_PIN(134) + TLMM_PIN_IO_REGISTER)

#define TRI_STATE_KEY_SILENT_STATUS_ADDR                                           \
  (TLMM_WEST + TLMM_ADDR_OFFSET_FOR_PIN(125) + TLMM_PIN_IO_REGISTER)
// OP7TP Modify end
