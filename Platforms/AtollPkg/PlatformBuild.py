# @file
# Script to Build Atoll Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("AtollPkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Atoll', 'edk2-build', 'cibuild')
    WorkspaceRoot = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    PackagesPath = ("Binaries", "Platforms", "MU_BASECORE", "Common/MU", "Common/MU_TIANO", "Common/MU_OEM_SAMPLE", "Common/MU_FEATURE_DFCI", "Silicon/ARM/TIANO", "Silicon/QC/Sm7125")
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def GetTargetDeviceDirectory(self):
        ...
        return os.path.join("Platforms", "AtollPkg", "Device", target_device)
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Atoll", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "AtollPkg/Atoll.dsc", "Platform Hardcoded")
