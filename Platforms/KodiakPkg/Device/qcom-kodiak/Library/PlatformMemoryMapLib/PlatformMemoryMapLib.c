...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    { "HLOS1",             0x80895000, 0x0000F000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    { "TPMControl",        0x808A4000, 0x00010000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, UNCACHED_UNBUFFERED_XN },
    { "HLOS2",             0x808B4000, 0x0004B000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    { "APSS",              0x808FF000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    ...
    { "HLOS3",             0x82B10000, 0x017F0000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    ...
    { "HLOS4",             0x9F600000, 0x00900000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    ...
    { "HLOS5",             0xA0002000, 0x007FE000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    // Is this OK? MPSS Located in Kernel Region, which is protected by tz.
    { "RESERV",            0xA0800000, 0x00300000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, UNCACHED_UNBUFFERED_XN },
//    { "HLOS6",             0xA0B00000, 0x1AB00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN },
    { "HLOS6",             0xA0B00000, 0x0F500000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN },
    ...
    { "DBI Dump",          0xC5100000, 0x00F00000, NoHob,  MMAP_IO, INITIALIZED, Reserv, UNCACHED_UNBUFFERED_XN },
    { "HLOS7",             0xC6000000, 0x00500000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    ...
    { "APSS Ext",          0xE3400000, 0x01700000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
...
//  0xE4B00000 - 0x280000000
    ...
    { "RAM Partition",     0xE4B40000, 0x9B4C0000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
#else
    { "RAM Partition",     0xE4B00000, 0x9B500000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
#endif

// Mapped 4GB till Here.
    { "TGCM",              0x180000000, 0x01400000, AddMem, MEM_RES, WRITE_COMBINEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
    { "RAM Partition",     0x181400000, 0x7EC00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
