...
// for samsung S10
    {"RAM Partition",     0x9C000000, 0x00400000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
    ...
    // 5GB avaliable on devices with sdx50m
...
#else
    // 6GB available on devices without sdx50m
