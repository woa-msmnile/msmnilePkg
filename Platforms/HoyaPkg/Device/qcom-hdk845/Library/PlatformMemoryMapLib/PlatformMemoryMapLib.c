...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    /* DDR Regions */
{ "Kernel"            ,0x0000000080000000, 0x0000000005600000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
{ "RAM Partition"     ,0x0000000085600000, 0x00000000006D0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "ipc_shm"           ,0x0000000085CD0000, 0x0000000000020000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
{ "boot_info"         ,0x0000000085CF0000, 0x0000000000010000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
{ "RAM Partition"     ,0x0000000085D00000, 0x0000000000200000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "HLOS1"             ,0x0000000085F00000, 0x00000000000C0000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
{ "RAM Partition"     ,0x0000000085FC0000, 0x0000000000020000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "AOP CMD DB"        ,0x0000000085FE0000, 0x0000000000020000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
{ "SMEM"              ,0x0000000086000000, 0x0000000000200000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
{ "RAM Partition"     ,0x0000000086200000, 0x0000000011A00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "DXE Heap"          ,0x0000000097C00000, 0x0000000005730000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN },
{ "DBI Dump"          ,0x000000009D330000, 0x00000000000D0000, NoHob,  MMAP_IO, INITIALIZED, Conv,   NS_DEVICE },
{ "Display Reserved"  ,0x000000009D400000, 0x0000000002400000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
{ "FV Region"         ,0x000000009F800000, 0x0000000000200000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
{ "ABOOT FV"          ,0x000000009FA00000, 0x0000000000200000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
...
{ "HLOS2"             ,0x000000009FFD0000, 0x0000000000027000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
...
{ "RAM Partition"     ,0x00000000A0000000, 0x0000000010400000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "MLVM"              ,0x00000000B0400000, 0x0000000009000000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
{ "RAM Partition"     ,0x00000000B9400000, 0x0000000080000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "RAM Partition"     ,0x0000000139400000, 0x0000000006C00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "RAM Partition"     ,0x0000000140000000, 0x0000000080000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "RAM Partition"     ,0x00000001C0000000, 0x000000003D1A0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
{ "MPSS_EFS"          ,0x00000001FD1A0000, 0x0000000000200000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, UNCACHED_UNBUFFERED_XN},
