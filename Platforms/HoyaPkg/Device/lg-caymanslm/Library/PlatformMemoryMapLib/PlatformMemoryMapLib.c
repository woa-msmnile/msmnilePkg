...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    { "QTEE"              ,0x0000000085fc0000,0x0000000002f40000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    { "AOP CMD DB"        ,0x0000000085FE0000,0x0000000000020000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "SMEM"              ,0x0000000086000000,0x0000000000200000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
    { "RAM Partition"     ,0x0000000086200000,0x0000000011A00000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    ...
    // Ram partitions
    { "RAM Partition"     ,0x00000000A0000000,0x0000000080000000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
