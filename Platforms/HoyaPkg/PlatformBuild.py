# @file
# Script to Build Hoya/Sdm845 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("HoyaPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Hoya', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "HoyaPkg/Hoya.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Hoya", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "HoyaPkg/Hoya.dsc", "Platform Hardcoded")
